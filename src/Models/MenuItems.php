<?php
namespace ggets\MenuBuilder\Models;
...
class MenuItems extends Model{
	...
	public function parent_menu(){
		return $this->belongsTo('ggets\MenuBuilder\Models\Menus', 'menu');
	}
	public function child(){
		return $this->hasMany('ggets\MenuBuilder\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
	}
}
